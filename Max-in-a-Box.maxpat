...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.5, 512.052884131669998, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 841.523218870162964, 557.820305615663528, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 888.511662721633911, 512.052884131669998, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 896.534881591796875, 557.820305615663528, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 987.488337278366089, 524.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 995.511556148529053, 569.76742148399353, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1025.0, 524.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1033.023218870162964, 569.76742148399353, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 192.767405033111572, 201.720914363861084, 68.0, 22.0 ],
									"text" : "$1, loop $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 188.0, 176.0, 46.0, 22.0 ],
									"text" : "route 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 214.0, 152.0, 56.0, 22.0 ],
									"text" : "listfunnel"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 194.627870082855225, 135.674405097961426, 72.0, 22.0 ],
									"text" : "patcherargs"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 116.418604135513306, 40.0, 22.0 ],
									"text" : "* 100.",
									"varname" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 61.139502763748169, 100.0, 50.0, 22.0 ],
									"text" : "r climax"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 91.37205982208252, 188.232542753219604, 58.0, 22.0 ],
									"text" : "line~ 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.162758111953735, 150.093009233474731, 45.0, 22.0 ],
									"text" : "$1 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 197.383646011352539, 376.348800182342529, 72.0, 22.0 ],
									"text" : "tapout~ 200"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 191.127870082855225, 339.116278886795044, 42.0, 22.0 ],
									"text" : "tapin~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 110.0, 399.32556414604187, 40.0, 22.0 ],
									"text" : "*~ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 240.0, 283.0, 47.0, 22.0 ],
									"text" : "*~ 0.98"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 191.127870082855225, 306.0, 59.0, 22.0 ],
									"text" : "tapout~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "tapconnect" ],
									"patching_rect" : [ 194.627870082855225, 268.052884131669998, 52.0, 22.0 ],
									"text" : "tapin~ 1"
								}
...
,
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 197.860465049743652, 230.0, 75.116281747817993, 20.0 ],
									"pitchcorrection" : 0,
									"quality" : "basic",
									"timestretch" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 194.627930000000106, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 110.0, 481.325561999999991, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 1021.0, 472.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 914.511662721633911, 539.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 947.0, 539.0, 40.0, 40.0 ],
					"size" : 1.0,
					"varname" : "pan"
				}
